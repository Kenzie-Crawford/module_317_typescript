...
var NCycle = /** @class */function () {
  ...
  NCycle.prototype.print = function (index) {
    ...
    } else if (Array.isArray(this.make) && Array.isArray(this.model) && this.make[index] !== undefined && this.model[index] !== undefined) {
  ...
  NCycle.prototype.printAll = function () {
    if (!Array.isArray(this.make) && !Array.isArray(this.model)) {
      ...
      var length = Math.min(this.make.length, this.model.length);
